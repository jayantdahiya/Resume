...
\begin{center}
    ...
    \small \href{tel://+91-9773039684}{\underline{+91-9773039684}} 
    $|$ 
    \href{https://www.jayantdahiya.com}{\underline{www.jayantdahiya.com}} 
    $|$ 
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: React.js, Next.js, Node.js, Laravel, MongoDB, FastAPI, TailwindCSS, GraphQL, Socket.io, Redis, Pusher} \\
...
\section{Experience}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Led chatbot feature development with \textbf{sub-400ms} latency for \textbf{1M+} daily users, using Laravel and WebSocket backend and React.js frontend. Integrated AI assistant via GPT-3.5-Turbo and LLAMA3, optimizing user engagement.}
        \resumeItem{Converted client-side application to \textbf{Next.js}, implementing \textbf{SSR} and dynamic SEO, resulting in a \textbf{40 \%} improvement in loading time and enhanced website performance.}
        \resumeItem{Managed 8 backend microservices with load balancing for 3 frontend apps. Implemented \textbf{redis pub-sub} and websocket servers using docker for efficient architecture and data management across \textbf{MongoDB} and \textbf{SQL} databases.}
      \resumeItemListEnd
